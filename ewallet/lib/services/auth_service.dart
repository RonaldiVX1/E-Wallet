...
class AuthService {
  ...
  Future<UserModel> testRegister(SignUpFormModel data) async {
    try {
      print(data.toJson());
      final res = await http.post(
        Uri.parse(
  ...
  Future<UserModel> testLogin(SignInFormModel data) async {
    try {
      final res = await http.post(
        Uri.parse(
          '$baseUrl/login',
  ...
  Future<UserModel> testLoginInvalidData(SignInFormModel data) async {
    try {
      final res = await http.post(
        Uri.parse(
          '$baseUrl/login',
  ...
  Future<String> testUpdateUser(UserEditFormModel data, String token) async {
    try {
      print(data.toJson());
      final res = await http.put(
        Uri.parse(
