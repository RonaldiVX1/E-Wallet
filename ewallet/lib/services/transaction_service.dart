...
class TransactionService {
  ...
  Future<String> testTopUp(TopupFormModel data, String token) async {
    try {
      print(data.toJson());
      final res = await http.post(
        Uri.parse('$baseUrl/top_ups'),
  ...
  Future<String> testTopUpWrongPin(TopupFormModel data, String token) async {
    try {
      print(data.toJson());
  ...
  Future<String> testTransfer(TransferFormModel data, String token) async {
    try {
      print(data.toJson());
      final res = await http.post(
        Uri.parse('$baseUrl/transfers'),
  ...
  Future<String> testTransferWrongPin(TransferFormModel data, String token) async {
    try {
      print(data.toJson());
